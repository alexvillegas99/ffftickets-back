...
let SalesService = SalesService_1 = class SalesService {
    ...
    async create(createSaleDto, logSale) {
        try {
            ...
            console.log(...oo_oo(`200733270_87_6_87_72_4`, 'Tiene compras pendientes', verifyExist ? 'Si' : 'No'));
            if (verifyExist) {
                for (const existingSale of verifyExist) {
                    ...
                    else if (existingSale.sale.payType === pay_types_enum_1.PayTypes.DEBIT_CARD) {
    ...
    async deleteSaleAndTickets(saleDelete) {
        ...
        console.log(...oo_oo(`200733270_202_4_202_46_4`, 'Cancelando Tickets', sale.id));
        for (const locality of localities) {
            await this.ticketService.deleteTicketsAndUpdateLocalities(locality, sale.id);
        }
        console.log(...oo_oo(`200733270_209_4_209_44_4`, 'Cancelando venta', sale.id));
    ...
    async verifyPendingPurchases(customer) {
        try {
            ...
            const salesWithLocalities = sales.map((sale) => {
                ...
                const localities = Object.entries(localityTicketInfo).map(([localityName, ticketInfo]) => ({
                    localityName,
    ...
    async validateSaleAdmin(id, body) {
        try {
            ...
            console.log(...oo_oo(`200733270_691_6_691_58_4`, 'Código transacción: ', transactionCode));
            ...
            console.log(...oo_oo(`200733270_704_6_704_23_4`, sale));
            ...
            console.log(...oo_oo(`200733270_710_6_710_36_4`, 'Se fue al error'));
            this.logger.error(error);
            (0, custom_error_helper_1.customError)(error);
        }
    }
    ...
    async generateDataToEmailCompleteOrder(id) {
        try {
            ...
            console.log(...oo_oo(`200733270_807_0_807_18_4`, error));
        }
    }
    ...
    async findPendingPurchasesTransfersAndCancel() {
        try {
            ...
            let expiredPurchases = await this.saleRepository
                ...
                .getMany();
            expiredPurchases = expiredPurchases.filter((sale) => !(sale.transfer_photo !== null && sale.status === sale_status_enum_1.SaleStatus.INCOMPLETE));
            if (expiredPurchases.length > 0) {
                console.log(...oo_oo(`200733270_877_10_877_80_4`, 'Cancelando compras pendientes de pago por transferencia'));
                this.CancelSalesForLotes(expiredPurchases, pay_types_enum_1.PayTypes.TRANSFER);
            }
            return expiredPurchases;
        }
        catch (error) {
            console.error(...oo_tx(`200733270_883_6_883_26_11`, error));
            throw error;
        }
    }
    async findPendingPurchasesCardsAndCancel() {
        try {
            ...
            const expiredPurchases = await this.saleRepository
                ...
                .getMany();
            if (expiredPurchases.length > 0) {
                console.log(...oo_oo(`200733270_925_10_925_74_4`, 'Cancelando compras pendientes de pago por tarjeta'));
                this.CancelSalesForLotes(expiredPurchases, pay_types_enum_1.PayTypes.DEBIT_CARD);
            }
            return expiredPurchases;
        }
        catch (error) {
            console.error(...oo_tx(`200733270_931_6_931_26_11`, error));
            throw error;
        }
    }
